            ...
            else
            {
                for (var i = 0; i < listProp.arraySize; i++)
                {
                    ...
                    if (showOrder)
                    {
                        ...
                        var elementRect = isSerie ? new Rect(drawRect.x, drawRect.y, drawRect.width + INDENT_WIDTH - 2 * ICON_GAP, drawRect.height) : new Rect(drawRect.x, drawRect.y, drawRect.width - 4 * ICON_WIDHT, drawRect.height);
