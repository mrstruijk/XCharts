...
namespace XCharts.Runtime
{
    ...
    public class AxisAnimation : ChildComponent
    {
        ...
        /// <summary>
        ///     the duration of animation (ms). When it is set to 0, the animation duration will be automatically calculated
        ///     according to the serie.
        ...
        public float duration
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Duration, value))
                {
                    SetComponentDirty();
                }
            }
        ...
        public bool unscaledTime
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_UnscaledTime, value))
                {
                    SetComponentDirty();
                }
            }
