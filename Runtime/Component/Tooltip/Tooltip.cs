...
namespace XCharts.Runtime
{
    ...
    public class Tooltip : MainComponent
    {
        ...
        [SerializeField]
        private LabelStyle m_TitleLabelStyle = new()
        {
            textStyle = new TextStyle {alignment = TextAnchor.MiddleLeft}
        };
        [SerializeField]
        private List<LabelStyle> m_ContentLabelStyles = new()
        {
            new() {textPadding = new TextPadding(0, 5, 0, 0), textStyle = new TextStyle {alignment = TextAnchor.MiddleLeft}},
            new() {textPadding = new TextPadding(0, 20, 0, 0), textStyle = new TextStyle {alignment = TextAnchor.MiddleLeft}},
            new() {textPadding = new TextPadding(0, 0, 0, 0), textStyle = new TextStyle {alignment = TextAnchor.MiddleRight}}
        };
        ...
        public TriggerOn triggerOn
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_TriggerOn, value))
                {
                    SetAllDirty();
                }
            }
        ...
        {
            for (var i = 0; i < runtimeDataIndex.Count; i++)
            {
