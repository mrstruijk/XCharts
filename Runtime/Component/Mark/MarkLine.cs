...
namespace XCharts.Runtime
{
    ...
    public class MarkLine : MainComponent
    {
        ...
        [SerializeField] private List<MarkLineData> m_Data = new();
        ...
        public bool onTop
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_OnTop, value))
                {
                    SetVerticesDirty();
                }
            }
    ...
    public class MarkLineData : ChildComponent
    {
        ...
        [SerializeField] private SymbolStyle m_StartSymbol = new();
        [SerializeField] private SymbolStyle m_EndSymbol = new();
        ...
        /// <summary>
        ///     The value specified on the X-axis. A value specified when the X-axis is the category axis represents the index of
        ///     the category axis data, otherwise a specific value.
        ...
        /// <summary>
        ///     That's the value on the Y-axis. The value specified when the Y axis is the category axis represents the index of
        ///     the category axis data, otherwise the specific value.
        ...
        /// <summary>
        ///     Grouping. When the group is not 0, it means that this data is the starting point or end point of the marking line.
        ///     Data consistent with the group form a marking line.
