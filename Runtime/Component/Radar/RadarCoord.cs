...
namespace XCharts.Runtime
{
    ...
    public class RadarCoord : CoordSystem, ISerieContainer
    {
        ...
        [SerializeField] private List<Indicator> m_IndicatorList = new();

        public RadarCoordContext context = new();
        ...
        public AxisLine axisLine
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_AxisLine, value, true))
                {
                    SetAllDirty();
                }
            }
        ...
        public AxisName axisName
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_AxisName, value, true))
                {
                    SetAllDirty();
                }
            }
        ...
        public AxisSplitLine splitLine
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_SplitLine, value, true))
                {
                    SetAllDirty();
                }
            }
        ...
        public AxisSplitArea splitArea
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_SplitArea, value, true))
                {
                    SetAllDirty();
                }
            }
        ...
        public override void SetDefaultValue()
        {
            ...
            {
                new() {name = "indicator1", max = 0},
                new() {name = "indicator2", max = 0},
                new() {name = "indicator3", max = 0},
                new() {name = "indicator4", max = 0},
                new() {name = "indicator5", max = 0}
            };
        ...
        {
            var indicatorNum = indicatorList.Count;
            var angle = 0f;
