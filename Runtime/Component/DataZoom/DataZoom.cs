...
namespace XCharts.Runtime
{
    ...
    public class DataZoom : MainComponent, IUpdateRuntimeData
    {
        ...
        public enum FilterMode
        {
            ...
            /// <summary>
            ///     data that outside the window will be filtered, which may lead to some changes of windows of other axes.
            ///     For each data item, it will be filtered only if all of the relevant dimensions are out of the same side of the
            ///     window.
        ...
        [SerializeField] private List<int> m_XAxisIndexs = new() {0};
        [SerializeField] private List<int> m_YAxisIndexs = new();
        ...
        [SerializeField] private LineStyle m_LineStyle = new(LineStyle.Type.Solid);
        [SerializeField] private AreaStyle m_AreaStyle = new();
        [SerializeField] [Since("v3.5.0")] private MarqueeStyle m_MarqueeStyle = new();
        [SerializeField] [Since("v3.6.0")] private bool m_StartLock;
        [SerializeField] [Since("v3.6.0")] private bool m_EndLock;

        public DataZoomContext context = new();
        private CustomDataZoomStartEndFunction m_StartEndFunction;
        private Dictionary<int, AxisIndexValueInfo> m_XAxisIndexInfos = new();
        private Dictionary<int, AxisIndexValueInfo> m_YAxisIndexInfos = new();
        ...
        {
            get => m_StartEndFunction;
            set => m_StartEndFunction = value;
        }
