...
namespace XCharts.Runtime
{
    ...
    public class LabelLine : ChildComponent, ISerieComponent, ISerieDataComponent
    {
        ...
        [SerializeField] private SymbolStyle m_StartSymbol = new() {show = false, type = SymbolType.Circle, size = 3};
        [SerializeField] private SymbolStyle m_EndSymbol = new() {show = false, type = SymbolType.Circle, size = 3};
