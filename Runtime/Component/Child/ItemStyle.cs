...
namespace XCharts.Runtime
{
    ...
    public class ItemStyle : ChildComponent, ISerieDataComponent
    {
        ...
        /// <summary>
        ///     Serie's mark color. It is only used to display Legend and Tooltip, and does not affect the drawing color. The
        ...
        public float[] cornerRadius
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_CornerRadius, value, true))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public void Reset()
        {
            ...
            {
                for (var i = 0; i < m_CornerRadius.Length; i++)
                {
                    m_CornerRadius[i] = 0;
                }
            }
