...
namespace XCharts.Runtime
{
    ...
    public class CommentItem : ChildComponent
    {
        ...
        [SerializeField] private CommentMarkStyle m_MarkStyle = new() {show = false};
        [SerializeField] private LabelStyle m_LabelStyle = new() {show = false};
        [SerializeField] [Since("v3.5.0")] private Location m_Location = new() {align = Location.Align.TopLeft, top = 0.125f};
