...
namespace XCharts.Runtime
{
    ...
    public class Legend : MainComponent, IPropertyChanged
    {
        ...
        [SerializeField] private Location m_Location = new() {align = Location.Align.TopCenter, top = 0.125f};
        ...
        [SerializeField] private LabelStyle m_LabelStyle = new();
        [SerializeField] [Since("v3.10.0")] private TextLimit m_TextLimit = new();
        [SerializeField] private List<string> m_Data = new();
        [SerializeField] private List<Sprite> m_Icons = new();
        [SerializeField] private List<Color> m_Colors = new();
        [SerializeField] [Since("v3.1.0")] protected ImageStyle m_Background = new() {show = false};
        [SerializeField] [Since("v3.1.0")] protected Padding m_Padding = new();
        [SerializeField] [Since("v3.6.0")] private List<Vector3> m_Positions = new();

        public LegendContext context = new();
        ...
        /// <summary>
        ///     The distance between each legend, horizontal distance in horizontal layout, and vertical distance in vertical
        ///     layout.
        ...
        ///     组件是否需要刷新
        /// </summary>
        public override bool componentDirty => m_ComponentDirty || location.componentDirty || labelStyle.componentDirty || textLimit.componentDirty;
        ...
        public void SetButton(string name, LegendItem item, int total)
        {
            ...
            var index = context.buttonList.Values.Count;
