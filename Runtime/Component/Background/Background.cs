...
namespace XCharts.Runtime
{
    ...
    public class Background : MainComponent
    {
        ...
        [SerializeField] [Since("v3.10.0")] private BorderStyle m_BorderStyle = new();
        ...
        public float imageWidth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ImageWidth, value))
                {
                    SetComponentDirty();
                }
            }
        ...
        public float imageHeight
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_ImageHeight, value))
                {
                    SetComponentDirty();
                }
            }
        ...
        public BorderStyle borderStyle
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_BorderStyle, value))
                {
                    SetComponentDirty();
                }
            }
