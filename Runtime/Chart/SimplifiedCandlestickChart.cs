...
{
    /// <summary>
    ///     A simplified candlestick chart is a simplified mode of a bar chart that provides better performance by simplifying
    ...
    public class SimplifiedCandlestickChart : BaseChart
    {
        protected override void DefaultChart()
        {
            ...
            for (var i = 0; i < GetSerie(0).dataCount; i++)
            {
                AddXAxisData("x" + (i + 1));
            }
        }
