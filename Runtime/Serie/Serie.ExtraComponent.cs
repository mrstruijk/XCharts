...
namespace XCharts.Runtime
{
    public partial class Serie
    {
        ...
        [SerializeField] [IgnoreDoc] private List<EndLabelStyle> m_EndLabels = new();
        [SerializeField] [IgnoreDoc] private List<LineArrow> m_LineArrows = new();
        ...
        /// </summary>
        public LabelStyle label => m_Labels.Count > 0 ? m_Labels[0] : null;

        public LabelStyle endLabel => m_EndLabels.Count > 0 ? m_EndLabels[0] : null;
        ...
        ///     ||折线图的箭头。
        /// </summary>
        public LineArrow lineArrow => m_LineArrows.Count > 0 ? m_LineArrows[0] : null;
        ...
        public ISerieComponent EnsureComponent(Type type)
        {
            ...
            throw new Exception(string.Format("Serie {0} not support component: {1}",
