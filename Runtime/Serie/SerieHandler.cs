...
namespace XCharts.Runtime
{
    ...
    public abstract class SerieHandler<T> : SerieHandler where T : Serie
    {
        ...
        private readonly float[] m_LastRadius = new float[2] {0, 0};
        private readonly float[] m_LastCenter = new float[2] {0, 0};
                ...
                if (chart.onSerieEnter != null || chart.onSerieExit != null || serie.onEnter != null || serie.onExit != null)
                {
                    if (serie.context.pointerEnter)
                    {
                        if ((serie.onExit != null || chart.onSerieExit != null) && m_LastPointerDataIndex >= 0)
                        {
                            ...
                            {
                                serie.onExit(exitEventData);
                            }

                            if (chart.onSerieExit != null)
                            {
                                chart.onSerieExit(exitEventData);
                            }
                        ...
                        {
                            serie.onEnter(enterEventData);
                        }

                        if (chart.onSerieEnter != null)
                        {
                            chart.onSerieEnter(enterEventData);
                        }
            ...
            foreach (var serieData in serie.data)
            {
                    ...
                    !isIgnore)
                {
                    if (serie.multiDimensionLabel)
                    {
                        ...
                        for (var i = 0; i < serieData.context.dataLabels.Count; i++)
                        {
                            if (i >= serieData.context.dataPoints.Count)
                            {
                                continue;
                            }
        ...
        {
            return ChartHelper.IsZeroVector(serieData.context.labelPosition) ? serieData.context.position : serieData.context.labelPosition;
        }
        ...
        {
            if (serie.onDown == null && chart.onSerieDown == null)
            {
                return;
            }
        ...
        public override void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (serie.onClick == null && chart.onSerieClick == null)
            {
                return;
            }
