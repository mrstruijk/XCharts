...
namespace XCharts.Runtime
{
    ...
    public partial class Serie : BaseSerie, IComparable
    {
        ...
        [SerializeField] private AnimationStyle m_Animation = new();
        [SerializeField] private ItemStyle m_ItemStyle = new();
        [SerializeField] private List<SerieData> m_Data = new();
        [SerializeField] private List<SerieDataLink> m_Links = new();
        ...
        [NonSerialized] public List<SerieData> m_FilterData = new();
        ...
        public string coordSystem
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_CoordSystem, value, true))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public string serieType
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_SerieType, value, true))
                {
                    SetVerticesDirty();
                }
            }
        ...
        /// </summary>
        public string legendName => string.IsNullOrEmpty(serieName) ? ChartCached.IntToStr(index) : serieName;
        ...
        public SerieColorBy colorBy
        {
            ...
            get => m_ColorBy == SerieColorBy.Default ? defaultColorBy : m_ColorBy;
            set
            {
        ...
        /// <summary>
        ///     If stack the value. On the same category axis, the series with the same stack name would be put on top of each
        ///     other.
        ...
        /// <summary>
        ///     Index of layout component that serie uses. Default is -1 means not use layout, otherwise use the first layout
        ///     component.
        ...
        public int minShow
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinShow, value < 0 ? 0 : value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public int maxShow
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MaxShow, value < 0 ? 0 : value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public int maxCache
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MaxCache, value < 0 ? 0 : value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public float sampleDist
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_SampleDist, value < 0 ? 0 : value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        /// <summary>
        ///     The gap between bars between different series, is a percent value like '0.3f' , which means 30% of the bar width,
        ///     can be set as a fixed value.
        ///     Set barGap as '-1' can overlap bars that belong to different series, which is useful when making a series of bar be
        ///     background.
        ...
        public float barZebraWidth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BarZebraWidth, value < 0 ? 0 : value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public float barZebraGap
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BarZebraGap, value < 0 ? 0 : value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public AnimationStyle animation
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Animation, value, true))
                {
                    SetVerticesDirty();
                }
            }
        ...
        {
            get => m_ShowDataDimension;
            set => m_ShowDataDimension = Mathf.Clamp(value, 2, 10);
        }
        ...
        /// <summary>
        ///     Turn on the threshold for mass optimization. Enter performance mode only when large is enabled and the amount of
        ///     data is greater than the threshold.
        ///     ||开启大数量优化的阈值。只有当开启了large并且数据量大于该阀值时才进入性能模式。
        /// </summary>
        public int largeThreshold
        {
            get => m_LargeThreshold;
            set
            {
        ...
        /// <summary>
        ///     If the pie chart and labels are displayed externally, whether to enable the label overlap prevention policy is
        ///     disabled by default. If labels are crowded and overlapped, the positions of labels are moved to prevent label
        ///     overlap.
        ///     ||在饼图且标签外部显示的情况下，是否启用防止标签重叠策略，默认关闭，在标签拥挤重叠的情况下会挪动各个标签的位置，防止标签间的重叠。
        /// </summary>
        public bool avoidLabelOverlap
        {
            get => m_AvoidLabelOverlap;
            set
            {
        ...
        public bool minShowLabel
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinShowLabel, value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        {
            get => m_MinShowLabelValue;
            set
            {
                if (PropertyUtil.SetStruct(ref m_MinShowLabelValue, value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        ///     数据节点的边。
        /// </summary>
        public List<SerieDataLink> links => m_Links;
