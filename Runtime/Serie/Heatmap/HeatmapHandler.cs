...
namespace XCharts.Runtime
{
    ...
    internal sealed partial class HeatmapHandler : SerieHandler<Heatmap>
    {
        ...
        private readonly Dictionary<int, int> m_CountDict = new();
                                                      ...
                                                      ref List<SerieParams> paramList, ref string title)
        {
            ...
            if (serie.heatmapType == HeatmapType.Count)
            {
                ...
                if (!m_CountDict.TryGetValue(dataIndex, out value))
                {
                    return;
                }
        ...
        private void DrawDataHeatmapSerie(VertexHelper vh, Heatmap serie)
        {
            ...
            for (var n = 0; n < serie.dataCount; n++)
            {
                    ...
                    emphasisStyle.itemStyle.borderWidth > 0)
                {
                    ...
                    var emphasisBorderColor = emphasisItemStyle.opacity > 0 ? emphasisItemStyle.borderColor : ChartConst.clearColor32;
                    var emphasisBorderToColor = emphasisItemStyle.opacity > 0 ? emphasisItemStyle.borderToColor : ChartConst.clearColor32;
