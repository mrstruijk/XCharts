...
namespace XCharts.Runtime
{
    ...
    public partial class BaseChart
    {
        ...
        {
            set => m_CustomDrawGaugePointerFunction = value;
            get => m_CustomDrawGaugePointerFunction;
        }
        ...
        {
            set => m_OnAxisPointerValueChanged = value;
            get => m_OnAxisPointerValueChanged;
        }
        ...
        {
            set => m_OnLegendClick = value;
            internal get => m_OnLegendClick;
        }
        ...
        {
            set => m_OnLegendEnter = value;
            internal get => m_OnLegendEnter;
        }
        ...
        {
            set => m_OnLegendExit = value;
            internal get => m_OnLegendExit;
        }
        ...
        /// <summary>
        ///     Remove all of them Serie. This interface is used when Serie needs to be removed only, and RemoveData() is generally
        ///     used in other cases.
