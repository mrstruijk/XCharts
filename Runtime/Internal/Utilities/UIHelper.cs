...
namespace XCharts.Runtime
{
    ...
    public static class UIHelper
    {
        ...
        internal static void InitBackground(UIComponent table)
        {
            ...
            var sizeDelta = table.background.imageWidth > 0 && table.background.imageHeight > 0 ? new Vector2(table.background.imageWidth, table.background.imageHeight) : table.graphSizeDelta;
