...
namespace XCharts.Runtime
{
    ...
    public class ViewControl : ChildComponent
    {
        ...
        public float alpha
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Alpha, value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public float beta
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Beta, value))
                {
                    SetVerticesDirty();
                }
            }
    ...
    public class GridCoord3D : CoordSystem, IUpdateRuntimeData, ISerieContainer
    {
        ...
        [SerializeField] private ViewControl m_ViewControl = new();

        public GridCoord3DContext context = new();
        ...
        public float boxWidth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BoxWidth, value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public float boxHeight
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BoxHeight, value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public float boxDepth
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_BoxDepth, value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        public bool xyExchanged
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_XYExchanged, value))
                {
                    SetVerticesDirty();
                }
            }
        ...
        ///     ||3D视角控制组件。
        /// </summary>
        public ViewControl viewControl => m_ViewControl;
        ...
        {
            if (!context.maxRect.Contains(pos))
            {
                return false;
            }

            if (UGLHelper.IsPointInPolygon(pos, context.pointA, context.pointB, context.pointC, context.pointD))
            {
                return true;
            }

            if (UGLHelper.IsPointInPolygon(pos, context.pointB, context.pointF, context.pointG, context.pointC))
            {
                return true;
            }
            ...
            if (IsLeft())
            {
                if (UGLHelper.IsPointInPolygon(pos, context.pointC, context.pointG, context.pointH, context.pointD))
                {
                    return true;
                }
                else if (UGLHelper.IsPointInPolygon(pos, context.pointA, context.pointE, context.pointF, context.pointB))
                {
                    return true;
                }
            }
