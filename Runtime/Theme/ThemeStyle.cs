...
namespace XCharts.Runtime
{
    ...
    public class ThemeStyle : ChildComponent
    {
        ...
        [NonReorderable]
        #endif
        [SerializeField] private List<Color32> m_CustomColorPalette = new(13);
        ...
        public Color32 backgroundColor
        {
            get
            {
                ...
                return m_EnableCustomTheme ? m_CustomBackgroundColor : sharedTheme.backgroundColor;
            }
        }
        ...
        /// </summary>
        public List<Color32> colorPalette => m_EnableCustomTheme ? m_CustomColorPalette : sharedTheme.colorPalette;

        public List<Color32> customColorPalette
        {
            get => m_CustomColorPalette;
            set
            {
        ...
        public void CheckWarning(StringBuilder sb)
        {
            ...
            for (var i = 0; i < sharedTheme.colorPalette.Count; i++)
            {
